...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { contact: @phone.contact, contact_id: @phone.contact_id, phone: @phone.phone }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { contact: @phone.contact, contact_id: @phone.contact_id, phone: @phone.phone }
    assert_redirected_to phone_path(assigns(:phone))
  end
